    ...
    def select_item(a):
        ...
        def addtocartbtnfunc():
            ...
            if(custname.strip()==""):
                ...
                mycursor.execute(query,(str(int(a_qtyEntry['text'])-1),a_idEntry['text']))
                data = mycursor.fetchall()
                for i in data:
        ...
        s_qtyLabel = Label(popupWin,text="Qty Aval. : ",bg = 'powder blue',font = ('times',20,'bold italic'),anchor='w')
        ...
        a_qtyEntry = Label(popupWin,width=32,font=('arial',12,'italic'),bd=5,bg='light pink')
